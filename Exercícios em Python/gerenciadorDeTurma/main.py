...
class EnrollmentService():
    ...
    def enroll(self, student: "Student"):
        ...
        quantityOfStudentWaiting = len(self.waitingListRepository.get_student)

        if quantityOfStudentWaiting == 4:
            self.create_classroom(student)
            self.waitingListRepository = []
