...
class SQLiteEnrollmentRepository(IEnrollmentRepository):
    ...
    def save(self, student: "Student"):
        with self.conn:
            ...
            """, (
                ...
                student.age, 
                student.isNotified, 
                None  # Initially NULL for classroom_id
            ))
    ...
    def getAll(self):
        ...
        for row in rows: 
            ...
            student.classroom_id = row[5]  # Not a boolean, just the ID or None
    ...
    def getNotRegisteredStudents(self):
        ...
        for row in rows: 
            ...
            student.id = row[0]
            student.isNotified = bool(row[4])
            student.classroom_id = row[5]  # Should be None for not registered students
